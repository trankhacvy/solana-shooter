...
export default class LoadingScene extends Phaser.Scene {
    ...
    private addLoaderEvents() {
        this.load.on(Phaser.Loader.Events.PROGRESS, (value: number) => {
            this.percentText.setText(
                Number.parseInt(String(value * 100)) + "%"
            );
        ...
        this.load.on(
            ...
            (file: Phaser.Loader.File) => {
                this.assetText.setText("Loading file " + file.key);
            }
        );
    ...
    private loadCommon() {
        ...
        // new
        this.load.image("bg-city-1", "image/backgrounds/city_1.png");
        this.load.image("bg-city-2", "image/backgrounds/city_2.png");
        this.load.image("bg-city-3", "image/backgrounds/city_3.png");

        this.load.image("mint-bg", "image/backgrounds/mint_background.png");
        this.load.image("app-logo", "image/logo.png");
    }

    private loadMainMenu() {
        this.load.image("logo-doggo", "image/logo_doggo.png");
    ...
    private loadGameUI() {
        this.load.image("btn-pause", "image/ui/pause.png");
        this.load.image("btn-return", "image/ui/return.png");
        this.load.image("btn-leave", "image/ui/leave.png");
        this.load.image("bg-dialog", "image/ui/dialog-bg.png");
        // icons
        this.load.image("icon-skull", "image/icons/skull.png");
        this.load.image("icon-star", "image/icons/star.png");
    ...
    private loadEnemies() {
        ...
        enemyFiles.forEach((file) => {
            this.load.spritesheet(file, `spritesheets/enemies-v2/${file}.png`, {
                frameWidth: 150,
                frameHeight: 150,
            });
        });
