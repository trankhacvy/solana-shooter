...
import { EnemyV2 } from "../components/EnemyV2";
...
export default class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        // let p = new PlayerLevelBar(this, 400, 300);

        // setInterval(() => {
        //     p.fill(this.count, 2000);
    ...
    private addBackground(): void {
        const background = this.add.image(0, 0, "bg-city-3").setOrigin(0, 0);
    ...
    //     const starsField = this.add
    //         .image(-300, -300, "stars-field")
    //         .setRotation(-1);
    ...
    private addLogo(): void {
        const logoRick = this.add.image(0, 0, "logo-doggo").setScale(0.8);
