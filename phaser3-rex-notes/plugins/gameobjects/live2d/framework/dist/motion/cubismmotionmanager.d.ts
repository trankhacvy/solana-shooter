...
import { ACubismMotion } from '../../src/motion/acubismmotion';
import { CubismMotionQueueEntryHandle, CubismMotionQueueManager } from '../../src/motion/cubismmotionqueuemanager';
/**
 * モーションの管理
 *
 * モーションの管理を行うクラス
...
import * as $ from '../../src/motion/cubismmotionmanager';
